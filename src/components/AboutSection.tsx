          ...
          >
            ...
            >
              <motion.span
                ...
                className="col-start-1 row-start-1 inline-flex items-center gap-2 rounded-full border border-[var(--border-subtle)] bg-[var(--text-primary)]/70 px-5 py-2.5 text-sm font-semibold text-[var(--bg-page)]/75 shadow-[0_10px_28px_rgba(0,0,0,0.2)]"
              >
                <span>About Me</span>
              ...
              <motion.span
                ...
                transition={{ type: "spring", stiffness: 280, damping: 22 }}
                className="col-start-1 row-start-1 inline-flex items-center gap-2 rounded-full border border-[var(--border-subtle)] bg-[var(--text-primary)]/90 px-5 py-2.5 text-sm font-semibold text-[var(--bg-page)]/75 shadow-[0_10px_28px_rgba(0,0,0,0.2)]"
              >
                <span>About Me</span>
                <span aria-hidden="true">-&gt;</span>
              </motion.span>
